...
const VERSION = 'acolia-v109';
const SHELL = ['/css/app.css', '/js/common.js', '/js/chat.js', '/js/voice.js', '/js/social.js', '/js/specialties.js', '/js/agenda.js', '/js/agenda-pro.js', '/js/catalog.js', '/js/profile-view.js', '/js/call.js', '/js/painel.js', '/js/delete-account.js', '/js/docs.js', '/js/quick-replies.js', '/js/secretary.js',
