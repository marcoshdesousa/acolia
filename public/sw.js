...
const VERSION = 'acolia-v85';
const SHELL = ['/css/app.css', '/js/common.js', '/js/chat.js', '/js/voice.js', '/js/social.js', '/js/catalog.js', '/js/profile-view.js', '/js/call.js', '/js/domino.js', '/js/painel.js', '/js/delete-account.js', '/js/docs.js',
