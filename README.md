...
## Mensagens
- **Uma a uma → apagar para todos** (só as suas mensagens, pelo ⋮ da mensagem): o conteúdo sai do banco (áudio também), o outro vê "Mensagem apagada" e para você some.
