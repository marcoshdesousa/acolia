...
- **Trocar o tipo (só o paciente):** até 30 minutos antes, o paciente toca em **"Trocar para online"** ou **"Trocar para presencial"**: a consulta continua **no mesmo dia e horário** e não gasta a remarcação. Para presencial, ele confirma a cidade e recebe a localização. Ao **remarcar**, ele também escolhe Online ou Presencial para o novo dia. A troca só aparece se a outra opção estiver aberta na agenda e tiver **o mesmo valor já pago** (pelo convênio, sempre); com valor diferente, cancela e marca de novo. Nas **contas de teste** tudo fica liberado para testar: troca e remarcação até 1 minuto antes, sem limite de remarcações e mesmo com valores diferentes. Quando não dá para trocar, a tela explica o motivo. O profissional não troca o tipo: ele usa "Não vou poder atender" (o paciente escolhe reembolso ou remarcar) e, antes do pagamento, "Cancelar agendamento".
