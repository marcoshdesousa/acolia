...
- **Consultas → aba Presenciais:** lista as consultas presenciais ("Você não tem nenhuma consulta presencial agendada" quando não há). Do horário em diante, cada uma pergunta **"Esta consulta presencial aconteceu?"** (o aviso fixo também lembra). **Sim, aconteceu** → fica concluída e o paciente entra em **Meus pacientes** como Presencial. **Não aconteceu** → some da lista e do histórico, sem precisar justificar. A presencial não conclui sozinha; o paciente deixa de vê-la depois do horário.
