...
- **Minha agenda:** além de "Disponível para atendimento online", quem tem consultório vê **"Disponível para atendimento presencial"** (começa ligado). Ao agendar só aparecem as opções ligadas: só online, só presencial ("No momento, só consulta presencial") ou as duas. Com as duas desligadas, aparece **"Sem agenda disponível"**. Os horários são os mesmos para as duas.
